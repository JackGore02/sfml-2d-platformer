...
///////////////////////////////////////
LJMU::LJMUMenuScreenRoot::LJMUMenuScreenRoot()
	:_selected_index(0)
{
...
//  Level.
/////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::loadContent()
{
...
//////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::handleEvent(const sf::Event& pevent)
{
...
//////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::bgUpdate(sf::Time & ptpf, sf::Time & ptotal, bool pcovered)
{
...
//////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::update(sf::Time & ptpf, sf::Time & ptotal)
{
...
//  the screen.
//////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::render()
{
...
//////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::cleanup()
{
...
// control.
///////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::handleInput(sf::Keyboard::Key pkey, bool ppressed)
{
	//Get Access to the Window via the Weak Pointer. 
...
///////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::loadResources()
{
...
///////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot ::setupMenuBG()
{
	//Get Access to the Window via the Weak Pointer. 
	auto& twndw = this->getLJMUSFMLManager().lock()->getWindow();
...
///////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::setupMenuElements()
{
	auto& twndw = this->getLJMUSFMLManager().lock()->getWindow();
	const sf::Vector2f tscrdim = sf::tof(twndw.getSize());
	...
	auto itemObptions = this->createMenuItem("Options Menu");
	this->addItem(itemObptions);
	...
	//Options
	this->_menu_actions[itemObptions].Actions[MenuActionType::Selection] = [&](MenuItemPtr tptr)
	{
	...
	this->_menu_actions[itemPlatformer].Actions[MenuActionType::Selection] = [&](MenuItemPtr tptr)
	{
		...
		tmgr->addScreen(std::make_shared<LJMU::LJMUGameScreenMain>(), tid);
	};
	...
	this->_menu_sprites.insert(std::make_pair(itemObptions, Options));
...
// Setup our Cameras
///////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot ::setupCameras()
{
	auto& twndw = this->getLJMUSFMLManager().lock()->getWindow();
	const sf::Vector2f tscrdim = sf::tof(twndw.getSize());
...
void LJMU::LJMUMenuScreenRoot::setupTitle()
{
...
////////////////////////////////////////
LJMU::LJMUMenuScreenRoot::MenuItemPtr LJMU::LJMUMenuScreenRoot::createMenuItem(std::string pdefaulttext)
{
...
////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::addItem(MenuItemPtr pitem)
{
...
////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::onMoveUp()
{
...
////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::onMoveDown()
{
	const int titems = static_cast<int>(this->_menu_items.size());
	int tindex = this->_selected_index + titems;
	this->_selected_index = ++tindex % titems;
...
//  Handle Back Events
////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::onCancel()
{
...
//  Handle Save Events
////////////////////////////////////////
void LJMU::LJMUMenuScreenRoot::onSaveAll()
{	
